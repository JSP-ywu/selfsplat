...
class PoseNet(nn.Module):
    ...
    def __init__(self, cfg, num_layers=34, pretrained=True):
        super(PoseNet, self).__init__()
        self.encoder = ResnetEncoder(
            num_layers=num_layers, pretrained=pretrained, bn_order="pre_bn", num_input_images=2)
    ...
    def forward(self, image_pair):
        ...
        features = self.encoder(image_pair)
