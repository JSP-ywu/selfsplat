...
from .blocks import Block, DecoderBlock, PatchEmbed, Mlp
...
class CroCoNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 adapt=False,            # whether to apply adapter (AdaptFormer)
                ):
        ...
        self.enc_depth = enc_depth # 12
        self.enc_embed_dim = enc_embed_dim # 768
        self.enc_blocks = nn.ModuleList([
            Block(enc_embed_dim, enc_num_heads, mlp_ratio, qkv_bias=True, norm_layer=norm_layer, rope=self.rope, adapt=self.adapt)
    ...
    def _set_decoder(self, enc_embed_dim, dec_embed_dim, dec_num_heads, dec_depth, mlp_ratio, norm_layer, norm_im2_in_dec):
        ...
        self.dec_blocks = nn.ModuleList([
            DecoderBlock(dec_embed_dim, dec_num_heads, mlp_ratio=mlp_ratio, qkv_bias=True, norm_layer=norm_layer, norm_mem=norm_im2_in_dec, rope=self.rope, adapt=self.adapt)
